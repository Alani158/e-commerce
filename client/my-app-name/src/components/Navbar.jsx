  ...
  return (
    <div className="w-full flex">
      <div className="flex w-full">
        <img src="elegant.png" alt="Logo" className="w-20 relative left-20 h-10" />
        ...
        <div className="flex w-[30vh] space-x-4 relative top-3">
          <Link to="/signup" className="relative  text-black hover:text-gray-600">
            Sign Up
          </Link>
          <CgShoppingBag className="w-5 h-5" />
          <IoPersonCircleSharp className="w-5 h-5" />
          <img src="two.png" alt="User Icon" className="w-5 h-5" />
        </div>
      </div>
    </div>
  );
